          ...
          >
            ...
            {selectedChat && (
              <>
                ...
                <Button style={{background:"8DDCFF "}} variant="info" onClick={handleScheduleClick}>
                  Request Video Call
                </Button>
              </>
            )}
          ...
          <div style={{ flex: "7", position: "relative", height: "calc(100vh - 160px)" }}>
                ...
                <>
                  {chatMessageLoading ? (
                    ...
                    <div className="row w-100 h-100 d-flex justify-content-center align-items-center">
                      <h3 style={{color:""}} className=" row w-100 d-flex justify-content-center align-items-center">
            ...
            {selectedChat && (
              ...
              >
                ...
                />
                <Button variant="success" style={{ background:"#7F7BFB ", padding: "10px 20px", borderRadius: "5px" }} onClick={sendMessage}>
                  Send
                </Button>
              </div>
            )}
